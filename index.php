...
//http://localhost/item.php?oqocii.go&&_page=fh_1&_cat=all&_pos=120&_type=img
...
//http://localhost/firsthand/all-2-0.go
...
echo $tem_list;
//echo pq('#productlist')->find('.pagelist')->prev()->html();  
...
{  
   $tem = pq($company)->html();  
   //echo pq($company)->find('strong')->html()."<br>";  
   //echo pq($company)->find('strong')->attr('href')."<br>";  
  // attr('value');
  //echo str_replace("world","John","Hello world!");
  //http://www.go2.cn/product/oamagi.go?_page=fh_1&_cat=all&_pos=2&_type=img
  //$tem = pq($company)->find('strong')->html();
  ...
  //echo '<div class="product-box">'.$tem.'</div>';
  //echo Pinyin('中文字','utf-8');
}  
echo '</div>';
//echo 'It is working!';
...
<script type="text/javascript">
	...
	//alert($(".pagelist li a").first().text());
